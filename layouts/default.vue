    ...
    <div class="v-navbar">
      <div class="v-navbar__content">
        <div class="v-navbar__logo" style="width: 60px; height: auto; margin:18px">
          <a href="/">
            <img src="~/static/img/grid.svg"  class="img-fluid" alt="Blog">
          </a>
        </div> 
        <div class="spacer" />
        <div class="v-navbar__img" style="margin: 50px -14px 0px -51px;">
          <ul class="v-navbar__links-items">
            ...
            <li>
            <a href="/"><img src="~/static/img/gmail.svg"  class="img-fluid" alt="Blog"></a>
            </li>
            </div>
          </ul>
        </div>
